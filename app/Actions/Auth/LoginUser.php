...
{
    /**
     * A real bcrypt hash of a value nobody knows. An identical error message is not
     * enough on its own: short-circuiting on `! $user` would skip bcrypt and answer
     * unknown emails ~14x faster. Every login pays exactly one comparison.
     */
    ...
    public function handle(LoginData $data): array
    {
        ...
        // One generic message for both branches — never reveal whether the email exists.
