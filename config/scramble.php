...
return [
     ...
     */
    // A wildcard (rather than the bare 'api' default) keeps the documented
    // `paths` as full `/api/...` strings instead of Scramble folding the
    // prefix into `servers` and stripping it from each path — the contract
    // (and this tier's DocsTest) asserts on paths like `/api/proposals`.
    'api_path' => 'api/*',
